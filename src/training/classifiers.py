...
def train_model(model_to_train, sample_identifier, k):
    """
    IGNOERE AAA
    ...
    if model_to_train == "naive_bayes":
        ...
        with open(f'data/models/voting_models/random_forest_model_{k}.pkl', 'rb') as file:
            random_forest = pickle.load(file)
        # Loads SVM model
        with open(f'data/models/voting_models/svm_model_{k}.pkl', 'rb') as file:
            svm_model = pickle.load(file)
        """
        #Loads knn
        with open(f'data/models/voting_models/knn_model_{k}.pkl', 'rb') as file:
    ...
    if 0 < k < 6000:
        ...
        #Saves selector
        with open(f'data/models/{sample_identifier}/selector_{model_to_train}.pkl', 'wb') as file:
